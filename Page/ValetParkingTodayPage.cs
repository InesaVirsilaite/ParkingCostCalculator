...
{
    public class ValetParkingTodayPage : BasePage
    {
        ...
        private IWebElement TodayDateEntry => Driver.FindElement(By.LinkText(DateTime.Today.Day.ToString()));
        ...
        public ValetParkingTodayPage(IWebDriver driver) : base(driver) { }
        ...
        public void todayEntryDayClick()
        {

            TodayDateEntry.Click();
        ...
        public void selectOctober(string month)
        {
